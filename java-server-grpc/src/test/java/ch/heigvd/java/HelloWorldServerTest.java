...
import ch.heigvd.java.service.MapServiceImpl;
...
public class HelloWorldServerTest {
  ...
  public void greeterImpl_replyMessage() throws Exception {
    ...
    /*grpcCleanup.register(InProcessServerBuilder
        .forName(serverName).directExecutor().addService(new MapImpl()).build().start());

    ch.heigvd.java.helloworld.GreeterGrpc.GreeterBlockingStub blockingStub = ch.heigvd.java.helloworld.GreeterGrpc.newBlockingStub(
